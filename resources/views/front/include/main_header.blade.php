                    ...
                    <li class="header__account--items d-none d-lg-block">
                     ...
                     <li class="header__account--items">
                        <a class="header__account--btn minicart__open--btn" href="javascript:void(0)" data-offcanvas>
                            ...
                            <span class="items__count" id="main_cart_count2">0</span>
                        </a>
                    </li>
                    @else
                     ...
                     <li class="header__account--items">
                        <a class="header__account--btn minicart__open--btn" href="javascript:void(0)" data-offcanvas>
                            <svg xmlns="http://www.w3.org/2000/svg" width="26.51" height="23.443" viewBox="0 0 14.706 13.534">
                             ...
                             <?php  $all_wish_list233 = DB::table('cart_tbls')->where('status',0)
                             ->where('user_id',Auth::user()->id)->count(); ?>
                            <span class="header__account--btn__text"> My cart</span>
                            <span class="items__count" id="main_cart_count2">{{ $all_wish_list233}}</span>
                        </a>
                    </li>
                ...
                <ul class="d-flex">
                    ...
                    <li class="header__account--items header__account2--items">
                        <a class="header__account--btn minicart__open--btn" href="javascript:void(0)" data-offcanvas>
                            ...
                            <span class="items__count style2" id="main_cart_count1">0</span>
                        </a>
                    </li>
                    @else
                    <li class="header__account--items header__account2--items">
...
<li class="header__account--items header__account2--items">
                        <a class="header__account--btn minicart__open--btn" href="javascript:void(0)" data-offcanvas>
                            <svg xmlns="http://www.w3.org/2000/svg" width="26.51" height="23.443" viewBox="0 0 14.706 13.534">
                             ...
                             <?php  $all_wish_list233 = DB::table('cart_tbls')->where('status',0)
                             ->where('user_id',Auth::user()->id)->count(); ?>
                            <span class="items__count style2" id="main_cart_count1">{{$all_wish_list233}}</span>
                        </a>
                    </li>
                    @endif
