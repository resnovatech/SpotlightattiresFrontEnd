<div class="predictive__search--box ">
    <div class="predictive__search--box__inner">
        ...
        <form class="predictive__search--form" action="{{route('search_product')}}" method="get">
            <label>
                <input class="predictive__search--input" id="search_product_in_mobile" name="product_name" placeholder="Search Here" type="text">
            </label>
