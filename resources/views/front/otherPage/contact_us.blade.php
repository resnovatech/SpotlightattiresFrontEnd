        ...
        <div class="container">
            ...
            <div class="main__contact--area position__relative">
                ...
                <div class="contact__form">
                    ...
                    <form class="contact__form--inner" id="SubmitForm">

                        {{-- <input type="text" name="ttt" id="ttt" > --}}
                        <div class="row">
                            <div class="col-lg-12 col-md-12">

                                    <label class="form" id="InputName">Name <span class="contact__form--label__star">*</span></label>
                                    <input class="contact__form--input"  id="main_name" placeholder="Your First Name" type="text">
                                    <span class="text-danger" style="color:red" id="nameErrorMsg"></span>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="contact__form--list mb-20">
                                    <label class="contact__form--label" id="InputMobile">Phone Number <span class="contact__form--label__star">*</span></label>
                                    <input class="contact__form--input"  id="main_phn" placeholder="Phone number" type="text">
                                    <span class="text-danger" style="color:red" id="mobileErrorMsg"></span>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="contact__form--list mb-20">
                                    <label class="contact__form--label" id="InputEmail">Email <span class="contact__form--label__star">*</span></label>
                                    <input class="contact__form--input" name="email" id="main_email" placeholder="Email" type="email">
                                    <span class="text-danger" style="color:red" id="emailErrorMsg"></span>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="contact__form--list mb-15">
                                    <label class="contact__form--label"  id="InputMessage">Write Your Message <span class="contact__form--label__star">*</span></label>
                                    <textarea class="contact__form--textarea" name="message"  id="main_msg" placeholder="Write Your Message"></textarea>
                                    <span class="text-danger" style="color:red" id="messageErrorMsg"></span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="contact__info--items">
                        ...
                        <div class="contact__info--items__inner d-flex">
                            ...
                            <div class="contact__info--content">
                                <p class="contact__info--content__desc text-white">Change the design through a range <br> <a href="tel:{{ $get_all_system_information->Phone }}">{{ $get_all_system_information->Phone }}</a>   </p>
                            </div>
                        </div>
                    </div>
                    <div class="contact__info--items">
                        ...
                        <div class="contact__info--items__inner d-flex">
                            ...
                            <div class="contact__info--content">
                                <p class="contact__info--content__desc text-white"> <a href="mailto:{{ $get_all_system_information->Email }}">{{ $get_all_system_information->Email }}</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="contact__info--items">
                        ...
                        <div class="contact__info--items__inner d-flex">
                            ...
                            <div class="contact__info--content">
                                <p class="contact__info--content__desc text-white">{{ $get_all_system_information->Address }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="contact__info--items">
                        ...
                        <ul class="contact__info--social d-flex">
                            ...
                            @foreach($ask_list_all as $all_ask_list_all)

                            @if($all_ask_list_all->question == 'facebook')
                            <li class="contact__info--social__list">
                                <a class="contact__info--social__icon" target="_blank" href="{{ $all_ask_list_all->ans }}">
                            ...
                            @elseif($all_ask_list_all->question == 'twitter')
                            <li class="contact__info--social__list">
                                <a class="contact__info--social__icon" target="_blank" href="{{ $all_ask_list_all->ans }}">
                            ...
                            @elseif($all_ask_list_all->question == 'Instagram')
                            <li class="contact__info--social__list">
                                <a class="contact__info--social__icon" target="_blank" href="{{ $all_ask_list_all->ans }}">
...
<script type="text/javascript">
    ...
    $('#SubmitForm').on('submit',function(e){
        ...
        let name = $('#main_name').val();
        let email = $('#main_email').val();
        let mobile = $('#main_phn').val();
