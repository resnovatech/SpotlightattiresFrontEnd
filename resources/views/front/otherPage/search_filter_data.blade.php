                    ...
                    <div class="shop__sidebar--widget widget__area d-none d-lg-block">
                        ...
                        <div class="single__widget widget__bg">
                            ...
                            <ul class="widget__categories--menu">
                                ...
                                <li class="widget__categories--menu__list {{ $cat_name_hidden == $all_main_category->cat_name ? 'Active':'' }}">
                                    ...
                                    <ul class="widget__categories--sub__menu">
                                        <li class="widget__categories--sub__menu--list">
                                            <div class="widget__form--check__list">
                                                <label class="widget__form--check__label" for="check1">{{$all_main_category->cat_name}}</label>

                                                @if($category_name == [])
                                                <input class="widget__form--check__input" id="check1" name="subcat[]" value="{{$all_main_category->cat_name}}"  type="checkbox">
                                                @else
                                                <input class="widget__form--check__input" id="check1" name="subcat[]" value="{{$all_main_category->cat_name}}" {{ (in_array($all_main_category->cat_name,$category_name)) ? 'checked' : '' }} type="checkbox">
                                                @endif
                                        ...
                                        <li class="widget__categories--sub__menu--list">
                                            <div class="widget__form--check__list">
                                                ...
                                                @else
                                                <input class="widget__form--check__input" name="subcat[]" id="check2" value="{{$all_sub_cat_list->sub_cat}}" {{ (in_array($all_sub_cat_list->sub_cat,$category_name)) ? 'checked' : '' }} type="checkbox">
                                                @endif
                                                <span class="widget__form--checkmark"></span>
                                            </div>
                                        </li>
                        ...
                        <div class="single__widget widget__bg">
                            ...
                            <ul class="widget__form--check">
                                ...
                                <li class="widget__form--check__list">
                                    ...
                                    @else
                                    <input {{ (in_array($all_size_atttribute->name_list,$size_value)) ? 'checked' : '' }} class="widget__form--check__input" name="size[]" id="check{{ $key+1 }}" value="{{ $all_size_atttribute->name_list }}" type="checkbox">
@endif
                                ...
                                <div class="price__filter--form__inner mb-15 d-flex align-items-center">
                                        ...
                                        <div class="price__filter--input border-radius-5 d-flex align-items-center">
                                            ...
                                            <label>
                                                <input class="price__filter--input__field border-0"
                                                       type="number" value="{{ $price_list_mainmin }}" name="from" placeholder="0" min="0"
                                                       >
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="price__filter--group">
                                        ...
                                        <div class="price__filter--input border-radius-5 d-flex align-items-center">
                                            ...
                                            <label>
                                                <input class="price__filter--input__field border-0"
                                                       name="to" type="number" value="{{ $price_list_mainmax }}" min="0"
                                                       placeholder="250" >
                                            </label>
                                        </div>
                                    </div>
                        ...
                        <div class="single__widget widget__bg">
                            ...
                            <ul class="widget__tagcloud">
                                ...
                                <input class="checkbox" id="lists{{ $key+1 }}" type="checkbox" name="color[]" value="{{ $all_color_atttribute->name_list}}" name="lists"  {{ (in_array($all_color_atttribute->name_list,$color_value)) ? 'checked' : '' }} />
                                @endif
                ...
                <div class="col-xl-9 col-lg-8">
                    <div class="shop__header bg__gray--color mb-30">
                        <div class="d-flex justify-content-start">
                            ...
                            @foreach($category_name as $all_category_name)
                            <div class="filter-box">
                                <div class="d-flex">
                                    <span class="pe-2">{{ $all_category_name }}</span>
                    ...
                    <div class="shop__product--wrapper">
                        <div class="product__section--inner product__grid--inner">
                            <div class="row row-cols-xl-4 row-cols-lg-3 row-cols-md-3 row-cols-2 mb--n30">
                               ...
                               @foreach($product_list as $all_feature_product_list)
