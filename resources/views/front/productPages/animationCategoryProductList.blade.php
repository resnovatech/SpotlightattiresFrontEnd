                        ...
                        <div class="single__widget widget__bg">
                            ...
                            <ul class="widget__categories--menu">
                                ...
                                <li class="widget__categories--menu__list">
                                    <a href="{{ route('animationCategory',$all_main_category->slug) }}"><label class="widget__categories--menu__label d-flex align-items-center">
                                        <img class="widget__categories--menu__img"
                                             src="{{ $url_name }}{{ $all_main_category->image }}" alt="categories-img">
                                        <span class="widget__categories--menu__text">{{$all_main_category->name}}</span>
